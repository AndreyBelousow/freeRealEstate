package com.ssau.freerealestate.web.entityEditors;
...
public class UserEditor extends VerticalLayout implements KeyNotifier {
    ...
    TextField username = new TextField("First username");
    TextField password = new TextField("Last username");
    ...
    public final void editCustomer(User c) {
        ...
        if (persisted) {
            ...
            customer = repository.getById(c.getId());
        }
        else {
            customer = c;
        }
        ...
        // Focus first username initially
        username.focus();
    }
